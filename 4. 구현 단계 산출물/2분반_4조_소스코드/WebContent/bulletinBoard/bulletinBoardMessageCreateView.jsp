...
<body>
   ...
   %>
	...
	<!-- 여기는 자신의 관리와 기능을 적을것 -->
	<h6>교육센터 통합 운영관리 시스템 - 게시글 관리 - 게시글 등록</h6>
	...
	<!-- 여기서부터 jsp화면 출력하는 부분 건들지 말것  header에서 부터 드래그해서 복사할것-->
		...
		<%
			String num = request.getParameter("bulletinBoardNum");

			session.setAttribute("bbd", num);
		%>
					
	<form action="bulletinBoardMessageCreate.jsp">
		<fieldset>
			...
			<table align="center">
				<tr>
					<td>유형</td>
					<td><SELECT name="bulletinBoardMessageType">
				...
				<tr>
					<td>제목</td>
					<td><input type="text" name="bulletinBoardMessage"></td>
				...
				<tr>
					<td>내용</td>
					<td><textarea cols="50" rows="5" name="bulletinBoardMessageContent"> </textarea></td>
				</tr>
				<tr>
					<td>첨부파일</td>
					<td><textarea name="attachment"> </textarea></td>
				</tr>
				<tr>
					<td><input type="hidden"  name="bulletinBoardNum" value="<%=num%>">
					</td>
				</tr>
				<tr>
					<td><input class="myButton" type="submit" id=addBtn value="등록"></td>
					<td><input class="myButton" type="button" onclick="cancleBtn()" value="취소"></td>
				</tr>
			</table>
		</fieldset>
	</form>
