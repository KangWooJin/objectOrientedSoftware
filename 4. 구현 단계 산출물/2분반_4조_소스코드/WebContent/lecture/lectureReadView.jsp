...
<%
	...
	for(int i = 0; i < size; i++){
		if(ld.get(i).memberID.equals("없음1")){
			%>
			<script>alert("로그인을 해야지 수강 조회를 할 수 있습니다!")</script>
...
<header>
   ...
   %>
	...
	<h6>교육센터통합운영관리 - 수강관리 - 수강관리 - 수강조회</h6>
	...
	<%int count = 1; %>
			...
			<table align="center" border="0" cellpadding=15 cellspacing=15 id="table1">
				...
				<tr height="30">
					...
					<td width="200" align="center">취소선택</td>
				</tr>
				<% for(int i = 0; i < size; i++){%>
				<tr height="30">
					...
					<form action="lectureCancel.jsp">
					<td width="200" align="center"><input class="myButton" type="submit" value="수강취소""></td>
