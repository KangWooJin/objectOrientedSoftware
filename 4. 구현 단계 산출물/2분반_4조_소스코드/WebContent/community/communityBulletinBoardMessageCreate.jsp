...
<body>
	...
	<% 
	String check = request.getParameter("wholeNoticeSatus");
	if ( check.equals("전체 공지"))
	{
		communityBulletinBoardMessage.wholeNoticeSatus="1";
	}
	else
	{
		communityBulletinBoardMessage.wholeNoticeSatus="0";
	}

	communityBulletinBoardMessageControl.insertCommunityBulletinBoardMessage(communityBulletinBoardMessage);
