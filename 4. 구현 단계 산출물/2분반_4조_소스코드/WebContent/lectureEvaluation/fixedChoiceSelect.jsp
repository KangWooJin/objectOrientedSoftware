...
<%
	session.setAttribute("fixedChoiceQuestionnaireID", request.getParameter("fixedChoiceQuestionnaireID"));
	
	String test = (String)session.getAttribute("fixedChoiceQuestionnaireID");
	out.println(test);
%>
