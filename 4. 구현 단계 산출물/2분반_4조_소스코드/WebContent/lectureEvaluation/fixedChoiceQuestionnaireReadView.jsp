		...
		<div>
			<form id=FixedChoiceQuestionnaireReadForm>
				<table width="900" cellpadding=10
					id=FixedChoiceQuestionnaireReadTable align="center">
			...
			for ( int i = 0 ; i < arr.size() ; ++i)
			{
				%>
					<tr>
						...
						<td align=center><%= arr.get(i).fixedChoiceQuestionTypeID%></td>
						<td align=center><%= arr.get(i).fixedChoiceQuestionDivision %></td>
						<td align=center><%= arr.get(i).fixedChoiceQuestionnaireContent %></td>
