...
<jsp:useBean id="er" class="project.lectureEvaluation.EvaluationResult" />
<jsp:useBean id="erControl"
	class="project.lectureEvaluation.EvaluationResultControl" />
...
<body>
   ...
   %>
	...
	<h6>교육센터 통합 운영관리 시스템 - 강의 평가 관리 - 강의 평가 결과 조회</h6>
		...
		<div>
			<form name=eqcReadForm>
				<table width="1150" cellpadding="15" cellspacing="15"
					...
					<%
						ArrayList<EvaluationResult> arr = erControl.select();

						String content = null;
						%>
					<tr>
						<th colspan=2 align=center>강의 코드</th>
						<th align=center>질문 번호</th>
						<th align=center>답안 번호</th>
...
%>
					<tr>
						<td colspan=2 align=center><%=arr.get(i).processCode%></td>
						<td align=center><%=arr.get(i).evaluationQuestionNumber%></td>
						<td align=center><%=arr.get(i).fixedChoiceQuestionnaireID%></td>
						<td align=center><%=arr.get(i).short_answerQuestion%></td>
						<%
						}
